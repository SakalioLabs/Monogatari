...
use llm_game::knowledge::{KnowledgeBase, KnowledgeCategory, KnowledgeEntry};
...
fn test_knowledge_base_get_by_tag() {
    ...
    let mut entry1 = KnowledgeEntry::new("loc1", KnowledgeCategory::Location, "Park", "A park.");
    entry1.tags = vec!["nature".to_string(), "peaceful".to_string()];

    let mut entry2 =
        KnowledgeEntry::new("char1", KnowledgeCategory::Character, "Sakura", "A girl.");
