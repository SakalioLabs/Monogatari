...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::endings::get_story_ending_catalog,
            commands::endings::save_story_ending,
            commands::endings::delete_story_ending,
            commands::endings::start_story_ending,
            commands::endings::preview_story_ending,
            ...
            commands::knowledge::get_knowledge_authoring_catalog,
            commands::knowledge::save_knowledge_entry_definition,
            commands::knowledge::delete_knowledge_entry_definition,
            ...
            commands::scene_roleplay::list_scene_roleplays,
            commands::scene_roleplay::get_scene_roleplay_authoring_catalog,
            commands::scene_roleplay::save_scene_roleplay_definition,
            commands::scene_roleplay::delete_scene_roleplay_definition,
            commands::scene_roleplay::start_scene_roleplay,
            commands::scene_roleplay::get_scene_roleplay_state,
            commands::scene_roleplay::send_scene_roleplay_turn,
            commands::campaign::list_roleplay_campaigns,
            commands::campaign::start_roleplay_campaign,
            commands::campaign::get_roleplay_campaign_state,
            commands::campaign::advance_roleplay_campaign,
