...
pub async fn get_workflow_nodes() -> Result<Vec<WorkflowNodeTypeInfo>, String> {
    Ok(vec![
        ...
        WorkflowNodeTypeInfo {
            ...
            configurable_fields: vec!["track_path".to_string(), "action".to_string(), "volume".to_string()],
        },
        WorkflowNodeTypeInfo {
        ...
        WorkflowNodeTypeInfo {
            ...
            category: "media".to_string(),
            configurable_fields: vec!["action".to_string(), "target_x".to_string(), "target_y".to_string(), "zoom".to_string(), "duration_ms".to_string()],
        },
        WorkflowNodeTypeInfo {
