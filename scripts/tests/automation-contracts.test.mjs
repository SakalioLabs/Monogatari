...
import './mcp-stdio-client.test.mjs'
import './locale-coverage-policy.test.mjs'
import './playwright-server-lifecycle.test.mjs'
import './project-dialogue-policy.test.mjs'
import './project-asset-import.test.mjs'
import './project-knowledge-reference-policy.test.mjs'
import './project-quality-suite-policy.test.mjs'
...
import './repository-json-policy.test.mjs'
import './repository-text-policy.test.mjs'
