...
| Browser authoring and Playtest workflows | `frontend-e2e` | Playwright Chromium tests against an isolated Vite server | Workspace navigation, deterministic Workflow trace/coverage/canvas evidence, validated browser character drafts and portable duplicate-ID rejection across reloads, dialogue save-to-Playtest handoff, the 29-scenario Quality workbench, and credential-free Settings manifest export across desktop and 390px mobile layouts |
