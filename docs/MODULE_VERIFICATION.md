...
3. Expose shared Quality execution through a schema-backed MCP tool with bounded project inputs and structured evidence, without moving transport concerns into the headless core.
