...
| Headless authoring core | `rust-authoring` | Unit, integration, and doc tests | Atomic content mutation, portable paths, project settings, multilingual prompt guards, deterministic conversation scoring/safety/event decisions, Agent transactions, and real core-runtime manager/reference validation without Tauri |
