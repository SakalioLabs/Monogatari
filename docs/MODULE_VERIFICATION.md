...
3. Continue decomposing `scripts/verify-release.mjs`; frontend, AI, and path source-invariant checks plus frontend route, release-channel, Web hosting, static distribution, and live browser preview validation now live in importable modules, while project-content and Tauri packaging gates remain in the entry point.
