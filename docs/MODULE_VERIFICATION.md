...
1. Continue frontend state-machine extraction after isolating Workflow authoring, preview, and execution presentation plus Quality Suite, Settings, Character, Dialogue, Story Event, Ending, and Knowledge domains; remaining large editor views plus end-to-end browser Story Playtest workflows remain.
