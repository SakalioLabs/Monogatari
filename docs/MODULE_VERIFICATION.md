...
3. Continue decomposing release verification; frontend, AI, path, route, release-channel, Web hosting/distribution/preview, and Tauri packaging evidence now live in importable modules. The project-content gate remains in `verify-release.mjs`, and the extracted Tauri collector still needs subdivision into packaging/mobile, installation, command-registration, and runtime-safety rule groups.
