...
- [ ] Quality Suites panel shows and exports versioned audit evidence with failed-scenario ids, category summaries, safety-signal counts, runtime safety trace guard notes, finalized guarded workflow output text, and workflow coverage summaries
