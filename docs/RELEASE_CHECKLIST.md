...
- [ ] Quality Suites panel shows and exports versioned audit evidence with run metadata, suite source paths, build commit ids, failed-scenario ids, category summaries, safety-signal counts, runtime safety trace guard notes, finalized guarded workflow output text, and workflow coverage summaries
