...
- [ ] `cd frontend && npm run build:web` emits manifest, service worker, offline fallback, `404.html`, `.nojekyll`, `_headers`, `staticwebapp.config.json`, `vercel.json`, and `project-assets.json` assets
