...
- [ ] Project export manifest includes a versioned schema marker, engine/build provenance, whole-package SHA-256 fingerprint, file inventory, per-file SHA-256 and legacy MD5 checksums, generated assets, and redacted sensitive settings
