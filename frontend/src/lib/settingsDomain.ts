...
const PREVIEW_PATHS: ReadonlyArray<Readonly<ProjectPathStatus>> = [
  ...
  { key: 'campaigns', label: 'Roleplay Campaigns', relative_path: 'campaigns', absolute_path: '', exists: true, item_count: 1, required: false },
...
export function createBrowserProjectManifest(options: {
  ...
  return {
    ...
    content_summary: {
      ...
      exported_categories: ['characters', 'dialogue', 'roleplays', 'campaigns', 'knowledge', 'scenes', 'assets', 'events', 'endings', 'locales', 'quality_suites', 'workflows'],
    },
    package: {
      file_count: 0,
      total_bytes: 0,
      ...
      directories: ['assets', 'campaigns', 'characters', 'dialogue', 'endings', 'events', 'knowledge', 'locales', 'quality_suites', 'roleplays', 'scenes', 'workflows'],
      files: [],
    },
    archive: {
      format: 'zip',
