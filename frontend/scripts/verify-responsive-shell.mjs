...
const viewportProfiles = [
  {
    ...
    sourceChecks: [
      ...
      [appSource, '.app-frame { display: grid; grid-template-columns: var(--sidebar-width) minmax(0, 1fr); height: 100vh; height: 100svh; min-height: 0; overflow: hidden;', 'app shell must be constrained to the viewport so content does not create document-level blank space'],
  ...
  },
  {
    ...
    sourceChecks: [
      ...
      [appSource, 'height: 100svh;', 'App.vue root must use small viewport height for tablet/mobile WebViews'],
      ...
      [appSource, '.app-workspace { display: grid; min-width: 0; height: 100%; min-height: 0;', 'workspace must reserve the remaining shell height for the main scroll track'],
    ],
    distChecks: [
