...
- Project export emits a versioned manifest with engine/build provenance, file inventory, per-file SHA-256 and legacy MD5 checksums, generated asset coverage, and redacted sensitive settings for package handoff.
