...
- Prompt-injection detection now covers English, Chinese, Japanese, and Korean prompt-control phrases before scoring, memory writes, relationship deltas, and runtime safety traces consume player text.
